...
class Custom extends Model
{
    ...
    {
        return ['0' => __('Custom_sms 0'), '1' => __('Custom_sms 1')];
    }
    ...
    public function getCustomSmsTextAttr($value, $data)
    {
        $value = $value ? $value : (isset($data['custom_sms']) ? $data['custom_sms'] : '');
        $list = $this->getCustomSmsList();
        return isset($list[$value]) ? $list[$value] : '';
    }
