            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'account_code', title: __('Account_code'), operate:false},
                        {field: 'account_date', title: __('Account_date'),operate:'RANGE',sortable:true, addclass:'datetimerange', autocomplete:false, formatter: Table.api.formatter.datetime},
                        ...
                        {field: 'account_object', title: __('Account_object'), sortable:true,operate: 'LIKE'},
                        //{field: 'account_custom_id', title: __('Account_custom_id')},
                        {field: 'account_amount', title: __('Account_amount'), operate:false},
                        {field: 'account_cost', title: __('Account_cost'), operate:false},
                        {field: 'account_paymentmode', title: __('Account_paymentmode'), sortable:true,operate: 'LIKE'},
                        {field: 'account_custom_account', title: __('Account_custom_account'), operate:'BETWEEN'},
                        {field: 'account_operator', title: __('Account_operator'), operate:false},
                        {field: 'account_statement_code', title: __('Account_statement_code'), operate: 'LIKE'},
                        {field: 'account_remark', title: __('Account_remark'),operate:false},
                        ...
                        {field: 'customcustom.custom_customtype', title: __('Customcustom.custom_customtype'), operate:false},
                        {field: 'customcustom.custom_businessarea', title: __('Customcustom.custom_businessarea'), operate:false},
                        {field: 'customcustom.custom_address', title: __('Customcustom.custom_address'), operate:false},
                        {field: 'customcustom.custom_tel', title: __('Customcustom.custom_tel'), operate:false},
                        {field: 'customcustom.custom_conact', title: __('Customcustom.custom_conact'), operate:false},
                        {field: 'customcustom.custom_IDentity', title: __('Customcustom.custom_identity'), operate:false},
                      ...
                      //  {field: 'financialstatement.statement_date', title: __('Financialstatement.statement_date')},
                        ...
                        {field: 'financialstatement.statement_mototype', title: __('Financialstatement.statement_mototype'), operate:false},
                       ...
                       // {field: 'financialstatement.statement_custom_id', title: __('Financialstatement.statement_custom_id')},
                        ...
                        {field: 'financialstatement.statement_product_price', title: __('Financialstatement.statement_product_price'), operate:false},
